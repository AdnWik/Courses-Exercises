...
with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S5_One-To-Many\S5L9.sql', 'r', encoding='utf-8') as file:
    sql = file.read()

cur.executescript(sql)

cur.executescript("""
DROP INDEX IF EXISTS esmartdata_course_instructor_id_idx;

CREATE INDEX esmartdata_course_instructor_id_idx ON esmartdata_course(instructor_id);
""")
