...
with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S5_One-To-Many\S5L12.sql', 'r', encoding='utf-8') as file:
    sql = file.read()
...
cur.execute("""
    SELECT instructor_id, COUNT(instructor_id) AS num_courses 
