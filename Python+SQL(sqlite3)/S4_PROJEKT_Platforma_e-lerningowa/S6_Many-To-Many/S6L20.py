...
with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S6_Many-To-Many\S6L20_1.sql', 'r', encoding='utf-8') as file:
    sql = file.read()
...
with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S6_Many-To-Many\S6L20_2.sql', 'r', encoding='utf-8') as file:
    sql = file.read()

cur.executescript(sql)

with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S6_Many-To-Many\S6L20_3.sql', 'r', encoding='utf-8')as file:
    sql = file.read()
