...
with open('Python+SQL(sqlite3)\S4_PROJEKT_Platforma_e-lerningowa\S7_Many-to-Many_dodatkowe_kolumny\S7L35.sql', 'r', encoding='utf-8') as file:
    sql = file.read()
...
cur.execute("""
    SELECT  "created",
            CAST(STRFTIME('%m', "created") AS INT) AS "month",
    CASE    
